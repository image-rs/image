...
impl DxgiFormat {
    ...
    pub(crate) fn bits_per_pixel(&self) -> Option<u8> {
        match *self {
            ...
            DxgiFormat::P010 | DxgiFormat::P016 => Some(24),
            ...
            DxgiFormat::NV12 | DxgiFormat::OPAQUE_420 | DxgiFormat::NV11 => Some(12),
            ...
            | DxgiFormat::BC7_UNORM_SRGB => Some(8),
