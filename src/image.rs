...
// TODO: Have other parts of the crate import these types directly.
pub(crate) use image_core::{ImageError, ImageResult, ImageDecoder, ImageDecoderExt, Progress};
...
mod tests {
    use std::io;
    use std::path::Path;
    use image_core::{ColorType, ImageDecoder, ImageResult};

    use super::{GenericImage, GenericImageView, load_rect, ImageFormat};
