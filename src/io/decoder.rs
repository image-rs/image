...
pub trait ImageDecoder {
    ...
    ///
    /// The layout returned by an implementation of [`ImageDecoder::init`] must match the buffer
    /// expected in [`ImageDecoder::read_image`].
...
mod tests {
    ...
    fn total_bytes_overflow() {
        ...
        assert_eq!(D.init().unwrap().total_bytes(), u64::MAX);
